		...
		*/				
		...
		if ( $result ){
			...
			echo '<h2>Pages visited and number of visits per page.</h2>' . "\n";	
				...
				echo $t2 .'<td class="action-col-title title-footer" bgcolor="#FF0000" colspan="2">&nbsp;' . "\n";
				echo $t2 .'</td>' . "\n";
				echo $t1 .'</tr>' . "\n";
				echo $t1 .'<tr>' . "\n";
				echo $t2 .'<td class="title-footer" colspan="2"><h4>&nbsp;</h4></td>';
	...
	if ( $hit_result ){
		...
		if ( $total_ips > 0 ){
			...
			echo $t1 .'<h2> Visitors\' IP addresses and Information</h2>' . "\n";
				...
				echo $t2 .'<tr>' . "\n";
				echo $t3 .'<td class="title-footer" colspan="6" align="right"><h4>Total unique IP´s </h4></td>' . "\n";
				...
				echo $t2 .'</tr>' . "\n";
				echo $t2 .'<tr>' . "\n";
				echo $t3 .'<td class="title-footer" colspan="3"></td>' . "\n";
        ...
        <ul class="help">
            ...
            <li>	
                <ul class="author">
                    ...
                    <li><b>Plugin's documentation</b> <br /><small>(may be updated from time to time)</small></li>
                    <li>
                    ...
                    <li><b>Report errors/bugs or requests to</b><br /><small>Will reply within 3 working days</small></li>
                    <li>
                        ...
                        <br /><small>Send an email anytime or subscribe for updates</small>
                    </li>
                    
                    <li><b>Contact phone number</b><br /><small>(Only Monday to Friday )</small></li>
                    <li>
                        +27 76 706 4015 (ZA)
                    </li>
                </ul>
